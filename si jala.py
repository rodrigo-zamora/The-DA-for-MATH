...
def ajustarVida():
    ...
    if puntos == 6:
        asset_vida1 = resource_path("imagenes/full.png")
        vida1 = pygame.image.load(asset_vida1)
        
        asset_vida2 = resource_path("imagenes/full.png")
        vida2 = pygame.image.load(asset_vida2)

        asset_vida3 = resource_path("imagenes/full.png")
        vida3 = pygame.image.load(asset_vida3)

    elif puntos == 5:
        asset_vida1 = resource_path("imagenes/half2.0.png")
        vida1 = pygame.image.load(asset_vida1)
        ...
        asset_vida1 = resource_path("imagenes/empty.png")
        vida1 = pygame.image.load(asset_vida1)
        ...
        asset_vida2 = resource_path("imagenes/half2.0.png")
        vida2 = pygame.image.load(asset_vida2)
        ...
        asset_vida2 = resource_path("imagenes/empty.png")
        vida2 = pygame.image.load(asset_vida2)
        ...
        asset_vida3 = resource_path("imagenes/half2.0.png")
        vida3 = pygame.image.load(asset_vida3) 
        ...
        asset_vida3 = resource_path("imagenes/empty.png")
        vida3 = pygame.image.load(asset_vida3) 
...
class Avatar(pygame.sprite.Sprite):
    ...
    def mover(self, time, keys):
        ...
        elif avatarRecangulo.colliderect(posiblesRespuesta_2_rect):
        ...
        elif avatarRecangulo.colliderect(posiblesRespuesta_3_rect):
        ...
        elif avatarRecangulo.colliderect(posiblesRespuesta_4_rect):
        ...
        elif avatarRecangulo.colliderect(posiblesRespuesta_5_rect):
...
def planets():
    ...
    asset_empezar = resource_path("imagenes/Empezar.png")
    empezar = pygame.image.load(asset_empezar)
    empezar_rect = empezar.get_rect()
    empezar_rect.center = (180, 400)

    asset_creditos = resource_path("imagenes/Creditos.png")
    creditos = pygame.image.load(asset_creditos)
    creditos_rect = creditos.get_rect()
    creditos_rect.center = (179, 550)

    asset_back = resource_path("imagenes/Fondos/Planetas.png")
    back = pygame.image.load(asset_back)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONUP:
                ...
                if salir_who_rect.collidepoint(event.pos):
                    who_we_are = False
        if who_we_are != False:
            asset_who = resource_path("imagenes/Fondos/Créditos.png")
            who = pygame.image.load(asset_who)
...
def gameLost():
    ...
    asset_lostImage = resource_path("imagenes/Fondos/Planetas.png")
    lostImage = pygame.image.load(asset_lostImage)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONUP:
                if texto_no_rect.collidepoint(event.pos):
                    ...
                    operadores = ["+"]
                    #Resetear los niveles desbloqueados a ninguno
                    nivelesDesbloqueados = []
                    gameMenu()
...
def gameMenu():
    ...
    asset_avatarNivel1 = resource_path("imagenes/aa2.png")
    avatarNivel1 = pygame.image.load(asset_avatarNivel1)
    ...
    asset_avatarNivel2 = resource_path("imagenes/nivel2.png")
    avatarNivel2 = pygame.image.load(asset_avatarNivel2)
    ...
    asset_avatarNivel3 = resource_path("imagenes/nivel3.png")
    avatarNivel3 = pygame.image.load(asset_avatarNivel3)
    ...
    asset_avatarNivel4 = resource_path("imagenes/nivel4.png")
    avatarNivel4 = pygame.image.load(asset_avatarNivel4)
    ...
    asset_mainImage = resource_path("imagenes/Fondos/Planetas.png")
    mainImage = pygame.image.load(asset_mainImage)
    displaySurface = pygame.display.set_mode((screenWidth, screenHeight))
...
def main():
    ...
    asset_background_image = resource_path("imagenes/Fondos/mapa2.png")
    background_image = pygame.image.load(asset_background_image)
    ...
    while gameRunning == True:
        ...
        if gameHelp == True:
            asset_helpImage = resource_path("imagenes/Fondos/how2play.png")
            helpImage = pygame.image.load(asset_helpImage)
            ...
            asset_helpImage = resource_path("imagenes/Fondos/Youwin.png")
            helpImage = pygame.image.load(asset_helpImage)
            helpImage = pygame.transform.scale(helpImage, (960,700))
            salir_rect.center = (50, 40)
            screen.blit(helpImage, (0, 0))
            ...
            if esperandoRespuesta == False:
                ...
                aleatorio_1, aleatorio_2 = random.randint(1, 5), random.randint(1, 5)
                aleatorio_3, aleatorio_4 = random.randint(1, 5), random.randint(1, 5)
                aleatorio_5, aleatorio_6= random.randint(1, 5), random.randint(1, 5)
                aleatorio_7, aleatorio_8 = random.randint(1, 5), random.randint(1, 5)
                ...
                while respuestaIncorrecta_1 == respuestaCorrecta or respuestaIncorrecta_1 == respuestaIncorrecta_2 or respuestaIncorrecta_1 == respuestaIncorrecta_3 or respuestaIncorrecta_1 == respuestaIncorrecta_4:
                    ...
                    aleatorio_1 = random.randint(1, 5)
                ...
                while respuestaIncorrecta_2 == respuestaCorrecta or respuestaIncorrecta_2 == respuestaIncorrecta_1 or respuestaIncorrecta_2 == respuestaIncorrecta_3 or respuestaIncorrecta_2 == respuestaIncorrecta_4:
                    ...
                    aleatorio_3 = random.randint(1, 5)
                ...
                while respuestaIncorrecta_3 == respuestaCorrecta or respuestaIncorrecta_3 == respuestaIncorrecta_1 or respuestaIncorrecta_3 == respuestaIncorrecta_2 or respuestaIncorrecta_3 == respuestaIncorrecta_4:
                    #Valor aleatorio 3, usado para las respuestas incorrectas
                    aleatorio_5 = random.randint(1, 5)
                    #Valor aleatorio 4, usado para las respuestas incorrectas
                ...
                while respuestaIncorrecta_4 == respuestaCorrecta or respuestaIncorrecta_4 == respuestaIncorrecta_1 or respuestaIncorrecta_4 == respuestaIncorrecta_2 or respuestaIncorrecta_4 == respuestaIncorrecta_3:
                    #Valor aleatorio 3, usado para las respuestas incorrectas
                    aleatorio_7 = random.randint(1, 5)
                    #Valor aleatorio 4, usado para las respuestas incorrectas
...
#SONIDO DE FONDO
cancion = resource_path("sonidos/fondo_todo.mp3")
