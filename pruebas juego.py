...
def gameMenu():
    ...
    while gameMenu == True:
        ...
        text = font.render("  Selecciona el nivel que deseas jugar  ", True, black)
...
if "2" in nivelesDesbloqueados:
    ...
    operadores.append("*")
elif "4" in nivelesDesbloqueados:
    operadores.append("/")
...
font32 = pygame.font.Font('freesansbold.ttf', 35)
...
salir = font32.render("[x]", True, red)
